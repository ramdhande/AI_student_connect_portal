def chatbot_reply(message):
    ...
    if any(w in message for w in hello_words):
        return "Hello there! I am the Student Connect AI Assistant. How can I guide you today? You can ask about exams, college fees, filing a grievance, or translation services."
